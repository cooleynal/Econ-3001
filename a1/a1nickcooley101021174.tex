...
\quad
$$
Additive commutativity in general linear systems (2x2) results in:
$$
A^T + B^T= 
\begin{bmatrix} 
      1 & 3 \\
...
\begin{enumerate}[label=(\alph*)]
      ...
      \begin{enumerate}[label=(\alph*)]
            ...
            \lim_{x \to -2^-}(x^2 + 5x) = -6
            $$
            $$\lim_{x \to -2^-}(x^2 + 5x) = -6 = \lim_{x \to -2^+}(x^2 + 5x) $$
            $$\lim_{x \to -2}(x^2 + 5x) = -6$$
            ...
            =
            \frac{2(2^+))^{\frac{3}{2}} - (4^+)^{\frac{1}{2}}}{(4^+)^2 - 15}
            =
            ...
            \lim_{x \to 4^-} \frac{2x^{\frac{3}{2}} - x^{\frac{1}{2}}}{x^2 - 15}
            =
            \frac{2(4^-))^{\frac{3}{2}} - (4^-)^{\frac{1}{2}}}{(4^-)^2 - 15}
            =
            \frac{2(2^-)(2^-)(2^-) - (2^-)}{(16^-) - 15}
            =
            \frac{16 - 2}{1}
            ...
            $\lim_{x \to a-}(A x^n) = A (a^-)^n = A a^n $
            \\\\
            If $n \in \{m| m$ is even $\mathbb{R^-} - \mathbb{Z^-}\}$  and $x$ never crosses the 0 region on $x \to a^-$ and $a \neq 0$, then:
            $$\lim_{x \to a^-}(A x^n) = A a^n = \lim_{x \to a+}(A x^n)$$
            $$\lim_{x \to a}(A x^n) = A x^n $$

            Case 5:
            \\
            Suppose $n \in \{m| m$ is odd $\mathbb{R} - \mathbb{Z}\}$ ie. 1.3, -22.1 and $a > 0$.
                       
            $\lim_{x \to a+}(A x^n) = A (a^+)^n = A a^n $

            $\lim_{x \to a-}(A x^n) = A (a^-)^n = A a^n $
            \\\\
            If $n \in \{m| m$ is odd $\mathbb{R} - \mathbb{Z}\}$ and $a > 0$, then:
            $$\lim_{x \to a^-}(A x^n) = A a^n = \lim_{x \to a+}(A x^n)$$
            $$\lim_{x \to a}(A x^n) = A x^n $$


            Otherwise, the two sided limit does not exist in $\mathbb{R}$.
      ...
      \begin{enumerate}[label=(\alph*)]
            ...
            $$ dz =  e^{xu}\left( \left(u+
            x \frac{\partial u}{\partial x} \right)dx +
            x \frac{\partial u}{\partial y} dy \right)
            $$
            ...
            let $u = ln(w)$ and $w = x^2 + y$.
            $$ dz = \frac{\partial u}{\partial w}\frac{\partial w}{\partial x} dx +
            \frac{\partial u}{\partial w}\frac{\partial w}{\partial y} dy
            $$

            $$ dz = \frac{\partial u}{\partial w} \left( \frac{\partial w}{\partial x} dx +
            \frac{\partial w}{\partial y} dy\right)
            $$

            $$ dz = \frac{1}{w} \left( 2x dx +
            dy\right)
            $$

            $$ dz = \frac{2xdx + 1dy}{x^2 + y}
            $$
...
\begin{question}
      ...
      \begin{enumerate}[label=(\alph*)]
            ...
            For all cases, if all else is constant.
